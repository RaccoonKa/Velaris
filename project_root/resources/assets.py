...
class Assets:
    ...
    def init(cls):
        ...
        cls.images['blackjack_choice'] = load_img(os.path.join("textures", "different", "blackjack.png"), (int(sc(410)), int(sc(350))))
        ...
        try:
            ...
            cls.images['all_chips'] = pygame.transform.smoothscale(raw, (int(raw.get_width() * Config.SCALE * 0.5), int(raw.get_height() * Config.SCALE * 0.5)))
        except Exception:
            cls.images['all_chips'] = pygame.Surface((sc(200), sc(200)), pygame.SRCALPHA)
